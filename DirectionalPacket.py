...
class DirectionalPacket:
    def __init__(self, SourceID, TargetID, PacketPara, distance):
        ...
        self.minisensi = DirectionalPacket.GetReceiveSensitivity(self.sf,self.bw)
        self.miniSNR = DirectionalPacket.GetMiniSNR(self.sf)
    ...
    def calculate_energy(tp, airtime):
        return DirectionalPacket.dbm_to_watt(tp) * airtime
